        ...
        <div style={s.page}>
            ...
            <div style={s.right}>
                <div style={s.form}>
                    ...
                    <p style={s.formSub}>Sign in to your command center</p>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        ...
                        <div>
                            <label style={s.label}>
                                Password
                                <span style={{ float: "right", color: "#a78bfa", fontSize: 12, cursor: "pointer" }}>Forgot password?</span>
                            </label>
                            <input
                                type="password" value={password} onChange={e => setPassword(e.target.value)}
                                placeholder="••••••••" required style={s.input} disabled={loading}
                            />
                        </div>
                    ...
                    <p style={s.footer}>
                        ...
                        <Link to="/signup" style={{ color: "#a78bfa", textDecoration: "none", fontWeight: 600 }}>Create account</Link>
                    </p>
                    <div style={s.tos}>
